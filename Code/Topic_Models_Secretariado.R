...
setwd("C:/Users/sergi/Dropbox/Universidad/Semestre 11M/Big Data PP/Trabajo Final/Comunicados/Secretariado")
...
myStopwords <- c("página", "pagina", "final", "si", "sí",  "artículo", 
                 ...
                 'nunca', 'vida', 'momento', 'hora', 'hecho', 'senor')
